...
urlpatterns = [
    ...
    path("checkout_order/<int:order_id>/<str:coupon_code>/",views.CheckOutOrderView.as_view(),name="checkout_order"),
    path("apply_coupon/<int:order_id>/",views.ApplyCoupon.as_view(),name="apply_coupon"),
]
